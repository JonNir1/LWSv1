...
t = trial_data[cnfg.TIME_STR].values
x = trial_data[cnfg.RIGHT_X_STR if subj.hand == DominantEyeEnum.Right else cnfg.LEFT_X_STR].values
y = trial_data[cnfg.RIGHT_Y_STR if subj.hand == DominantEyeEnum.Right else cnfg.LEFT_Y_STR].values
pupil = trial_data[cnfg.RIGHT_PUPIL_STR if subj.hand == DominantEyeEnum.Right else cnfg.LEFT_PUPIL_STR].values
