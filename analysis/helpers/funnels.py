...
import analysis.helpers.funnel_config as fcfg
...
from analysis.helpers.event_classification import check_lws_criteria, check_target_return_criteria
from data_models.LWSEnums import SearchArrayCategoryEnum, ImageCategoryEnum


def calculate_funnel_step_sizes(
